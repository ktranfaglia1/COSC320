/* Kyle Tranfaglia
*  COSC320 - Homework01 - Ex.1
*  Last updated 09/08/23
*  This program creates a dynamic array with random integer values, sorts it, and times the process
*/
#include <chrono>
#include <iostream>
#include <cstdlib>
...
int main() {
    ...
    int *array = new int[size]; // Creates dynamic integer array of size
    ...
    // Displays if array is sorted determined by the sorted boolean function
