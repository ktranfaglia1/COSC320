...
*  This program creates a dynamic array with Things, sorts it, and times the process
*/
#include <chrono>
#include <iostream>
#include <cstdlib>
...
int main() {
    ...
    Thing *array = new Thing[size]; // Creates dynamic Thing array of size
    // Fills array Things of random a and b values
    for (int i = 0; i < size; i++) {
        (array + i)->set(rand(), rand());
    }
